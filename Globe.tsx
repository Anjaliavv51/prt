<<<<<<< Updated upstream:components/ui/Globe.tsx
...
"use client"
import { useEffect, useRef, useState } from "react"
import { Color, Scene, Fog, PerspectiveCamera, AmbientLight, DirectionalLight, PointLight as THREEPointLight ,Group} from "three"
import ThreeGlobe from "three-globe"
...
=======
  const scene = new Scene()
  scene.fog = new Fog(0xffffff, 400, 2000)
  const pointLight = new THREEPointLight(0xff0000, 1, 100);
